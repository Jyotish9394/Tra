...
<div id="center">
  ...
  <div id="prof">
	 ...
	 include("connection.php");
	 $pid=$_GET['pid'];
	 $qry=mysql_query("select * from package,destinations where package.Destination=destinations.did and Pid='$pid'");
	 while($row=mysql_fetch_array($qry))
	 {
		 $pid=$row['Pid'];
		 $Name=$row['name'];
	 ...
	 ?>&nbsp;</p>
        <table width="539" height="231" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td><table width="539" height="231" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <th width="288" scope="row">PACKAGE ID</th>
              <td width="27">&nbsp;</td>
            ...
            <tr>
              <th scope="row">TRANSPORT SYSTEM</th>
              <td>&nbsp;</td>
  ...
  include("connection.php");
	...
	while($row=mysql_fetch_array($qry))
	{
		print "<a href='booking.php?pid=".$row['Pid']."'>Click Here Book</a>";
	}
  ?></div>
  </div>
</div>
