...
<div id="center">
  ...
  <div id="prof">
    ...
    include("connection.php");
	extract($_POST);
	$qry=mysql_query("select * from package,spotimage where package.Pid=spotimage.pid");
	...
	{
		print "<td>";
		print "<img src='../spot_image/".$row['Image']."' height=100 width=100>";
		print "<br>".$row['Spot_Name'];
		print "<br><a href='package_details.php?pid=".$row['Pid']."'>VIEW DETAILS</a>";
		print "</td>";
				print "</td>";
		$ct++;
		if($ct==4)
