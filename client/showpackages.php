...
<div id="center">
  ...
  <div id="apDiv5">
    <div id="apDiv10">
      <p>&nbsp;</p>
      <table width="539" height="83" border="1" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td><div align="center">DESTINATIONS OF 
          <?php
	  ...
	  ?> ARE</div></td>
		...
		$Pname=$_GET['pname'];
		extract($_POST);
		$qry=mysql_query(" select * from package,destinations where package.Destination=destinations.did and name='$Pname'");
