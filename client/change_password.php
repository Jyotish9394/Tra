  ...
  <?php
    ...
    <div id="pass">
      <form id="form1" name="form1" method="post" action="change_password1.php">
        <p>&nbsp;</p>
        <table width="410" height="170" border="0" cellpadding="0" cellspacing="0">
          <tr>
          ...
          <tr>
            <th height="34" scope="row">OLD PASSWORD</th>
            <td>&nbsp;</td>
            <td><input type="password" name="old_password" id="old_password" /></td>
          </tr>
          <tr>
            <th height="34" scope="row">NEW PASSWORD</th>
            <td>&nbsp;</td>
            <td><input type="password" name="new_password" id="new_password" /></td>
          </tr>
          <tr>
            <th height="43" scope="row">CONFIRM PASSWORD</th>
            <td>&nbsp;</td>
            <td><input type="password" name="confirm_password" id="confirm_password" /></td>
          </tr>
          <tr>
            <th height="41" colspan="3" scope="row"><input type="submit" name="button" id="button" value="change" /></th>
          </tr>
        </table>
        <p>&nbsp;</p>
      </form>
