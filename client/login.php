...
<div id="login">
  <form id="form1" name="form1" method="post" action="check.php">
    <div id="apDiv10"><a href="index.php">BACK TO HOME</a></div>
    <p>&nbsp;</p>
    <div align="center"></div>
    <table width="379" height="142" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <th width="126" scope="row"><div align="center">EMAIL</div></th>
        <td width="48">&nbsp;</td>
      ...
      <tr>
        <th height="40" colspan="3" scope="row"><p>
          <input type="submit" name="button" id="button" value="login" />
        </p>
        <p><a href="change_password.php">CLICK HERE TO RESET</a> </p></th>
      </tr>
    </table>
    <p><a href="register.php">New user?Create a new account</a></p>
  </form>
</div>
</body>
</html>