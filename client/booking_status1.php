  ...
  <div id="apDiv5">
    <div id="prof">
      ...
      <form id="form1" name="form1" method="post" action="booking_status1.php">
        <p>&nbsp;</p>
        <table width="829" height="91" border="1" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td width="164"><p align="center">PACKAGE</p>
            ...
            <td width="86"><div align="center">STATUS</div></td>
          </tr>
                <?php
		include("connection.php");
		extract($_POST);
		$qry=mysql_query(" select * from booking,package,destinations where booking.Pid=package.Pid and package.Destination=destinations.did and booking.Booking_id='$id'");
		 while($row=mysql_fetch_array($qry))
		 {
		  ...
		  print "<td align='center'>";
		   ...
		   print "<td align='center'>";
		   if($row['status']==0)
		   	print "<font color='#FFFF00'>Request not yet processed</font>";
