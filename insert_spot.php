      ...
      <table width="464" height="255" border="0" align="center">
        <tr>
          ...
          <td width="320"><label for="spotname"></label>
            <input type="text" name="spotname" id="Spotname" required="required" /></td>
        </tr>
        <tr>
          ...
          <td><label for="sname"></label>
            ...
            <textarea name="details" id="Details" cols="45" rows="5" required="required"></textarea></td>
        </tr>
        <tr>
          <th height="73" scope="row">Pid</th>
          <td>&nbsp;</td>
          <td><label for="pid"></label>
            <input type="text" name="pid" id="pid" required="required" /></td>
        </tr>
        <tr>
...
<div id="popup">
  ...
  include("connection.php");
	extract($_POST);
	$qry=mysql_query("insert into spots values('$Spotname','$Details','$pid')");
	if($qry)
	{
  ...
  <p>&nbsp;</p>
  <p>&nbsp; </p>
  <div id="apDiv9"><a href="add_spots.php">x</a></div>
</div>
</body>
</html>