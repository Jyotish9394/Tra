...
<div id="central">
  ...
  <div id="add">
    <form id="form1" name="form1" method="post" action="insert_packages.php">
      <p>&nbsp;</p>
      <table width="468" height="309" border="0">
        <tr>
          <th width="190" height="37" scope="row">PACKAGE ID</th>
          <td width="39">&nbsp;</td>
          <td width="225"><label for="id"></label>
            <input type="text" name="id" id="Pid" required="required" /></td>
        </tr>
        <tr>
          <th height="32" scope="row">Name</th>
          <td>&nbsp;</td>
          <td><div align="left">
        ...
        <tr>
          ...
          <td><label for="hotels"></label>
            <input type="text" name="hotels" id="Hotels" required="required" /></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td><label for="days"></label>
            <input type="text" name="days" id="Days" required="required"/></td>
        </tr>
        <tr>
          <th height="39" scope="row">MODE_OF_TRANSPORTS</th>
          <td>&nbsp;</td>
          <td><label for="Mode_of_transport"></label>
            <input type="text" name="Mode_of_transport" id="Mode_of_transport" required="required" /></td>
        </tr>
        <tr>
          <th height="27" scope="row">DESTINATIONS</th>
          <td>&nbsp;</td>
          <td><label for="Destinations"></label>
            <input type="text" name="Destination" id="destinations" required="required" /></td>
        </tr>
        <tr>
          <th height="27" colspan="3" scope="row"><input type="submit" name="button" id="button" value="Submit" /></th>
          </tr>
        <tr>
          <th height="27" colspan="3" scope="row">&nbsp;</th>
        </tr>
        </table>
      <p>&nbsp;</p>
    </form>
...
<div id="popup">
  ...
  <p>
	...
	extract($_POST);
	$qry=mysql_query("insert into package values('$Pid','$name','$Hotels','$Amount','$Days','$Mode_of_transport','$Destination')");
	if($qry)
	{
  ...
  <p>&nbsp;</p>
  <p>&nbsp; </p>
  <div id="apDiv9"><a href="add_packages.php">x</a></div>
</div>
</body>
</html>