...
<div id="central">
  <div id="content">
  <div id="head"></div>
  <div id="label">ADD DESTINATION DETAILS</div>
  <div id="add_dest">
    <form id="form1" name="form1" method="post" action="insert_dest.php">
      <p>&nbsp;</p>
      <table width="340" height="145" border="0">
        <tr>
  ...
  <div id="nav">
    <table width="1000" height="51" border="0">
      <tr>
        ...
        <th scope="col"  onmouseover="show('drop3')" onmouseout="hide('drop3')"><div  align="center"><a href="#" class="">PACKAGES</a></div></th>
        <th scope="col" onmouseover="show('drop4')" onmouseout="hide('drop4')"><div  align="center"><a href="#" class="">MANAGE BOOKING</a></div></th>
...
<div id="popup">
  ...
  <?php
	...
	extract($_POST);
	$qry=mysql_query("insert into destinations values('$dname','$did')");
	if($qry)
	{
  ...
  ?>
  &nbsp;</p>
  <div id="apDiv9"><a href="add_dest.php">X</a></div>
</div>
</body>
</html>