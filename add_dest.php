...
<div id="central">
  ...
  <div id="head"></div>
  <div id="apDiv9">
    <p>ADD DESTINATION DETAILS</p>
  </div>
  <div id="des">
    <form id="form1" name="form1" method="post" action="insert_destination.php">
      
        <table width="539" height="210" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <th width="179" scope="row"><div align="center">DESTINAATION ID</div></th>
            <td width="37">&nbsp;</td>
            <td width="323"><div align="left">
              <input type="text" name="did" id="did" onfocus="blur()" value="<?php
			  ...
			  $qry=mysql_query("select * from destinations where did='$id'");
          ...
          <tr>
            <th scope="row"><div align="center">DESTINATION NAME</div></th>
            <td>&nbsp;</td>
            <td><div align="left">
          ...
          <tr>
            <th colspan="3" scope="row"><div id="apDiv10">
