...
#central #content #updatepackage table {
	text-align: center;
}
</style>
...
<div id="central">
  ...
  <div id="updatepackage">
    <table width="600" height="185" border="1" align="center" cellpadding="0" cellspacing="0">
      <tr>
	  ...
	  while($row=mysql_fetch_array($qry))
	  {
		  ...
		  print "<input type='text' class='txt' name='pid' value='".$row['Pid']."'>";
		   print "<input type='hidden' name='h' value='".$row['Pid']."'>";
		  print "</td>";
		  print "<td align='center'>";
		   print "<input type='text' class='txt' name='name' value='".$row['name']."'>";
		  print "</td>";
		  print "<td align='center'>";
		   print "<input type='text' class='txt' name='hotels' value='".$row['Hotels']."'>";
		  print "</td>";
		   print "<td align='center'>";
		   print "<input type='text' class='txt' name='amount' value='".$row['Amount']."'>";
		  print "</td>";
		   print "<td align='center'>";
		   print "<input type='text' class='txt' name='days' value='".$row['Days']."'>";
		  print "</td>";
		   print "<td align='center'>";
		   print "<input type='text' class='txt' name='mode_of_transport' value='".$row['Mode_of_transport']."'>";
		  print "</td>";
		   print "<td align='center'>";
		   $did=$row['Destination'];
		   print "<select name='destination'>";
		   $qry1=mysql_query("select * from destinations where did='$did'");
