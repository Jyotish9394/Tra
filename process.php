...
<div id="central">
  ...
  <div id="head"></div>
  <div id="detalis">
    <div id="apDiv9"><a href="adminhome.php">x</a></div>
    <p>&nbsp;</p>
    <?php
  ...
  if(isset($_POST['accept']))
  	{
		$qry=mysql_query("update booking set status='1' where Booking_id='$h'");
 		 if($qry)
 			 {
			  print "BOOKING ACCEPT Successfully";
 			 }
 			 else
  			{
	 		 print mysql_error();
	...
	else
	{
		$qry=mysql_query("update booking set status='-1' where Booking_id='$h'");
 		 if($qry)
 			 {
			  print " BOOKING REJECT Successfully";
 			 }
 			 else
  			{
	 		 print mysql_error();
