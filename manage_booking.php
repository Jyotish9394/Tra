...
<div id="central">
  ...
  <div id="detalis">
    <p>&nbsp;</p>
    <table width="926" height="93" border="1" align="center" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="261"><div align="center">PROCESS</div></td>
      </tr>
      <?php
	  include("connection.php");
	  $qry=mysql_query("select * from destinations,package,booking,customer where booking.Pid=package.Pid and package.Destination=destinations.did and customer.Email=booking.Email and booking.status=0");
	 if(mysql_num_rows($qry)==0)
	 header("Location:nopackage.php");
	  while($row=mysql_fetch_array($qry))
	  {
		   print "<tr>";
		  print "<form name='f1' method='POST' action='process.php'>";
		  ...
		  print "</td>";
		 print "<td align='center'>";
		 print "<input type='submit' value='ACCEPT' name='accept'>";
		  print "<input type='submit' value='REJECT' name='reject'>";
		  print "</td>";
		  print "</form>";
		  print "</tr>";
	  }
