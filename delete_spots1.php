...
<div id="central">
  ...
  <div id="head"></div>
  <div id="delete">
    <p>DELETE SPOTS  DETAILS</p>
    <table width="476" height="57" border="1" cellpadding="1" cellspacing="1">
      <tr>
        <th width="96" scope="col">SPOT NAME</th>
        <th width="112" scope="col">DETAILS </th>
        <th width="129" scope="col">PACKAGE</th>
        <th width="116" scope="col">MODIFY</th>
      </tr>
        <?php
	  ...
	  while($row=mysql_fetch_array($qry))
	  {
		  ...
		  print "<tr bgcolor='#33FFFF'>";
		  print "<form name='f1' method='POST' action='delete_spots1.php'>";
...
include("connection.php");
  extract($_POST);
  $qry=mysql_query("delete from spots where Spot_name='$h'");
  if($qry)
  {
...
?>
  <div id="cut"><a href="delete_spots.php">x</a></div>
</div>
</body>
</html>