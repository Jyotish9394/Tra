...
<div id="central">
  ...
  <div id="head"></div>
  <div id="updatedest">
    <table width="394" height="47" border="1" align="center" cellpadding="0" cellspacing="0">
      <tr>
	  ...
	  while($row=mysql_fetch_array($qry))
	  {
		  ...
		  print "<input type='text' name='did' value='".$row['did']."'>";
		   print "<input type='hidden' name='h' value='".$row['did']."'>";
		  print "</td>";
		  print "<td align='center'>";
		   print "<input type='text' name='dname' value='".$row['dname']."'>";
		  print "</td>";
		  print "<td align='center'>";
...
<div id="apDiv9">
  ...
  include("connection.php");
  extract($_POST);
  $qry=mysql_query("update destinations set did='$did',dname='$dname' where did='$h'");
  if($qry)
  {
  ...
  ?>
  &nbsp;</p>
  <div id="apDiv10"><a href="update_dest.php"><font color="#FFFFFF">X</font></a></div>
</div>
</body>
</html>